...
#
# Generated by export_simulation on Mon May 15 17:49:02 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './ila_char_horizon1.sh' script.

./ila_char_horizon1.sh -reset_run
...
./ila_char_horizon1.sh -noclean_files

For more information on the script, please type './ila_char_horizon1.sh -help'.
