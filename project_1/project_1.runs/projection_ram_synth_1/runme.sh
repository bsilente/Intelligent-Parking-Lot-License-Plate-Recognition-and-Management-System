...
HD_PWD='C:/Users/14751/Desktop/ov5640_fun4_lcd_up3/project_1/project_1.runs/projection_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log projection_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source projection_ram.tcl
